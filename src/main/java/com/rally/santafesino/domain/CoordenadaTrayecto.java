...
/**
 * A CoordenadaTrayecto.
 */
@Entity
@Table(name = "coordenada_trayecto")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class CoordenadaTrayecto implements Serializable {
    ...
    public CoordenadaTrayecto id_coordenadas(Coordenadas coordenadas) {
    ...
    public CoordenadaTrayecto id_trayecto(Trayecto trayecto) {
    ...
    public boolean equals(Object o) {
        ...
        CoordenadaTrayecto coordenadaTrayecto = (CoordenadaTrayecto) o;
        if (coordenadaTrayecto.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), coordenadaTrayecto.getId());
    }
